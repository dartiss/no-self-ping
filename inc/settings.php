 ...
 */
function no_self_ping_settings_init() {

	add_settings_section( 'no_self_ping_section', __( 'No Self Pings', 'no-self-ping' ), 'no_self_ping_section_callback', 'discussion' );

	add_settings_field( 'no_self_pings_option', __( 'Additional URLs', 'no-self-ping' ), 'no_self_ping_setting_callback', 'discussion', 'no_self_ping_section', array( 'label_for' => 'no_self_pings_option' ) );

	register_setting( 'discussion', 'no_self_pings_option' );
}

add_action( 'admin_init', 'no_self_ping_settings_init' );
 ...
 */
function no_self_ping_section_callback() {
 ...
 */
function no_self_ping_setting_callback() {
